...
public class SubtaskEditActivity extends ActionBarActivity {
    private static String LOG = "creating subtask";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner priority = (Spinner)findViewById(R.id.subTask_edit_priority);
        ...
        if(subTaskDao.exists(subTask.getSubTaskID())) {
            ...
            priority.setSelection(subTask.getPriority());
    ...
    public void onClickSave(View v) {
        try {
            ...
            subTask.setPriority(((Spinner) findViewById(R.id.subTask_edit_priority)).getSelectedItemPosition());
