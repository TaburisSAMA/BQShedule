...
public class GanttTableAdapter extends BaseTableAdapter {
    ...
    public View getListView(View convertView) {
        ViewHolder holder;
    ...
    private View getGanttView(View convertView) {
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            taskName = _task.getName();
            task_bar.setGanttName(taskName);
            ...
            for (int j = 0; j < _children.size(); j++) {
                ...
                taskName = _subtask.getName();
                subtask_bar.setGanttName(taskName);
